...
abstract class AppLocalizations {
  ...
  /// No description provided for @selectImageSourceCamera.
  ///
  /// In en, this message translates to:
  /// **'Camera'**
  String get selectImageSourceCamera;

  /// No description provided for @selectImageSourceGallery.
  ///
  /// In en, this message translates to:
  /// **'Gallery'**
  String get selectImageSourceGallery;
}
